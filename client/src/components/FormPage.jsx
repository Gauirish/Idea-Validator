    ...
    return (
        <div className="chatgpt-layout">
            ...
            <div className="sidebar">
                ...
                <div className="social-links" style={{ marginTop: 'auto', paddingTop: '1rem', borderTop: '1px solid rgba(255, 255, 255, 0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <h4 style={{ fontSize: '0.85rem', color: '#94a3b8', marginBottom: '0.5rem', fontWeight: '600' }}>Connect with us</h4>
                    <div style={{ display: 'flex', gap: '0.75rem' }}>
                        <a href="https://www.instagram.com/schmoozemedia/" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s', display: 'flex' }} onMouseOver={(e) => e.currentTarget.style.color = '#fff'} onMouseOut={(e) => e.currentTarget.style.color = '#94a3b8'}>
                        ...
                        <a href="https://www.linkedin.com/search/results/all/?keywords=schmooze%20media&origin=RICH_QUERY_SUGGESTION&heroEntityKey=urn%3Ali%3Aorganization%3A31010396&position=3" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s', display: 'flex' }} onMouseOver={(e) => e.currentTarget.style.color = '#fff'} onMouseOut={(e) => e.currentTarget.style.color = '#94a3b8'}>
